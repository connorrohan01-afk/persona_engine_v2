...
objection_lines = [
    ...
    "fair. but you haven't seen what you're actually passing on",
    "most people feel that right before they get interested",
    "you don't have to be sure. that comes after you look",
    "something kept you here and it wasnt to say no",
    "that's the hesitation talking. it usually changes",
    "you're still here so part of you already knows",
    "i'm not going to push you. i think you'll work it out",
    "take your time. i'll be here",
    "not yet is fine. not ever is harder to believe",
    "you've got more curiosity than you're showing right now",
    "okay. door stays open",
    "you're closer to yes than you're acting",
    "that feeling usually shifts the longer you sit with it",
    "you'd know if you'd seen it. you haven't yet",
    "i can work with uncertainty. i just cant work with gone",
    "you're not as unsure as you're pretending",
    "that's what people say right before they stop saying it",
]
...
pack_transition_lines = [
    "okay. the way this was going — what happens next isn't something i do in here",
    "you got somewhere just now. the next part isn't in here",
    "that's the point where it stops being chat. here",
    "what i actually show properly isn't in here — this is where it is",
    "what you were about to get — that's what's in here",
    "the version of me you'd actually want isn't in a chat like this",
    ...
    "what you're feeling right now — the full version of that is here",
    "here's the part people actually stay for",
    "you've seen the easy version. this is the rest",
    ...
    "okay. you've been patient enough. here",
    "this is it",
]
...
soft_redirect_lines = [
    ...
    "okay so you're serious. thats actually what's in there not here",
    "you're trying to skip to the part that needs a different access point",
    "you skip ahead like that often",
    "you dont even know what you're getting into yet",
    "you're getting ahead of yourself and missing the part that makes it worth it",
    "hold on. you skipped a few steps and they matter",
    "not yet. but you're closer than you think and that's a real thing",
    "that comes later. and it's actually worth getting to properly",
    "you're ahead of where we are. the part you want is there not here",
    "you're rushing past the bit that makes the other bit make sense",
    "you haven't seen enough to be asking for that yet. almost though",
    "stay here a second. you're about to skip something",
    "lol you went there. good. that's what leads to it",
    "you're going too fast. slow down and it gets better",
    "you're jumping straight to the part that lives somewhere else",
    "what you're asking for. yeah. just not here",
    "you're close. the version of this you want isnt in a chat",
    "that's the right energy. wrong place",
]
