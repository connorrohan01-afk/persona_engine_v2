...
dry_user_lines = [
    ...
    "not really working with much here",
    "give me something to work with",
    "okay. whenever you're ready",
    "you're not even trying right now",
    "i've had more interesting silences",
    "lol okay. come back when you've got something",
    "you're holding back. why",
    "mm. i'll stay but you need to show up a bit more",
    "not much to go on there",
    "you haven't lost me. but you're not helping yourself",
    "you're going to have to put in a bit more effort than that",
    "i'm still here but you're making it difficult",
    "one word. really",
    "try again",
...
soft_redirect_lines = [
    ...
    "lol. you don't even know what that means here",
    "you're asking for the end before the middle",
    "that's not how this works",
    "interesting move. doesn't change anything",
    "you're a bit ahead of where we actually are",
    "you haven't earned that part yet",
    "nice try",
    "you're rushing. slow down",
    "you're already jumping to the end?",
    "hold on. you missed a few steps",
    "lol okay. calm down",
    "you're not there yet",
    "that's for later. stay here first",
    "you're moving fast for someone who hasn't seen much yet",
    "not yet. you'll know when",
    "you're ahead of yourself. catch up first",
]
