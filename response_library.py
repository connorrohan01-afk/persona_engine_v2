...
flirt_lines = [
    ...
    "that's more than i was expecting. keep going",
    ...
    "i was ready to be bored. i'm not",
    "you're not letting this go easy. i like that",
    "okay. you're more fun than i expected",
    "that worked better than it should have",
    "hm. you're doing something right and i haven't figured out what yet",
]
