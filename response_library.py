...
objection_lines = [
    "you haven't actually seen what you're saying no to yet",
    "that's fine. most people feel that before they look",
    "i'm not going to convince you. i think you'll get there",
    "fair. but you're not saying no to what you think you are",
    "you're not sold because you haven't seen it yet",
    "most people feel that right up until they don't",
    "that's usually what people say before they get curious",
    "you don't have to be sure yet. that comes later",
    "something brought you here and it wasn't to say no",
    "easy to say that before you know what you're passing on",
    "you're still here though",
    "take your time. i'll be here when you're ready",
    "you don't seem like someone who talks themselves out of things",
    "that usually shifts the more you sit with it",
    "you're closer to yes than you're acting right now",
    "i don't need to tell you you're wrong. you'll work it out",
    "not yet is fine. not ever is a different thing",
    "you've got more curiosity than you're letting on",
    "okay. your call. door's still open though",
    "i can work with hesitation. i can't work with gone",
]
...
exit_lines = [
    ...
    "you hadn't even seen the part that changes it",
    "you felt it and you're still going",
    ...
    "bit early for that. you hadn't seen the actual thing yet",
]
